...
var SQUARE_SIZE = screen.width*0.05;
...
function positionBoard()
{
    ...
    document.getElementById("score_card").style.width = "200px";
...
function canvasLoc(e)
{
    ...
    console.log("is located at: " + canvasXOffset + ", " + canvasYOffset);
    while (e) {
        canvasLocation[0] += (e.offsetLeft - e.scrollLeft + e.clientLeft);
        canvasLocation[1] += (e.offsetTop - e.scrollTop + e.clientTop);
        e = e.offsetParent;
    }
...
function dropPiece(e)
{
    ...
    // Check if the move is legal /// 													Ar legalus ejimas
